...
if 'vectorstore' not in st.session_state:
    st.session_state['vectorstore'] = 0
...
#         st.session_state['credentials'] = 0
...
if submitted0:
    ...
    if len(injuries)>0:
        ...
        if submitted1:
            ...
            ex_list = ''
            db.insert_user(username, name, hashed_password, email, gender, ex_per_day, str(biom_fact_dict), past_injuries, str_ratings, ex_list)
            col1.success('Submitted Successfully!')
    else:
        injuries = ''
        ratings = ''
