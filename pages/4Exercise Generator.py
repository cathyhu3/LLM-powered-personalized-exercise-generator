...
# Injury pain level form
    if db.get_injuries(username):
        ...
        with col1:
            ...
            change_injuries = st.button("Add or delete injuries")
            if change_injuries:
                with st.form("form1"):
            ...
            # EDIT LATER TO ADD BUTTON TO ALLOW USER TO EDIT ACCOUNT
            # edit_account = st.button("Edit account")
            # if edit_account:
...
##### CHAINS ################################################################################################################################################
    if st.session_state['sub_inj']:
        ...
        prompt4 = "Starting from these exercises: " + exlist + ", which exercises should I remove based on the patient's past injuries and their injury ratings,\
        ...
        # print("feedback about injuries: ", feedback1)
        ...
        # print("narrowed down after injuries: ", narrow1)
